...
export default function SupportPhones({ compact = false }: { compact?: boolean }) {
  return (
    <ul className={compact ? "mt-6 space-y-4" : "mt-6 grid gap-4 sm:grid-cols-3"}>
        ...
        <li key={phone.href}>
          ...
          >
            ...
            <span>
              ...
              <span className="mt-1 block text-sm font-medium">{phone.number}</span>
            </span>
          </a>
        </li>
      ))}

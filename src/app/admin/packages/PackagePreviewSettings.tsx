"use client";
import { PACKAGE_CATEGORIES, WEEKDAYS, type TravelPackage } from "@/lib/packageData";
...
export default function PackagePreviewSettings({ pkg, editing, change, disabled, filedUnderOptions }: {
  ...
  return <div className="rounded-xl border border-cmt-neutral-200 bg-white p-5">
    ...
    {editing && <details open className="mt-5 border-t border-cmt-neutral-200 pt-4"><summary className="cursor-pointer text-sm font-semibold">Catalogue & booking settings</summary><fieldset disabled={disabled} className="mt-4 space-y-4">

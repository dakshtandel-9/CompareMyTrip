...
import Price from "@/app/home/_components/Price";
import Rating from "@/app/home/_components/Rating";
import SectionHeader from "@/app/home/_components/SectionHeader";

/* ------------------------------------------------------------------ */
/* Compare before you book — design.md §17.4.                           */
/*                                                                       */
/* The /compare page's own copy of the homepage band (§17.4), kept        */
/* separate so this page can be reworked without touching the homepage.  */
/* Two differences from that one: it is named for the page rather than    */
/* the section, and it has no compare.enabled gate — the homepage band    */
/* can be switched off in the CRM, but this page is nothing without the   */
/* comparison, so it always renders.                                      */
/*                                                                       */
